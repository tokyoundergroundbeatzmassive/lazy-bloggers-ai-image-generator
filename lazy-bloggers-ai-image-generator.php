...
require_once TEXT2IMAGE_GENERATOR_PLUGIN_DIR . 'includes/set-featured-image.php';
require_once TEXT2IMAGE_GENERATOR_PLUGIN_DIR . 'includes/function-calling.php';
